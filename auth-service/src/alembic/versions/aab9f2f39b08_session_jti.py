...
def upgrade() -> None:
    ...
    op.add_column('sessions', sa.Column(
        'access_jti', postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column('sessions', sa.Column(
        'refresh_jti', postgresql.UUID(as_uuid=True), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('sessions', sa.Column('refresh_token',
                  sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('sessions', sa.Column('access_token',
                  sa.TEXT(), autoincrement=False, nullable=True))
